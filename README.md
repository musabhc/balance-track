# Balance Track 📊
**Akıllı Gelir ve Harcama Kontrol Merkezi**
...
- **Frontend:** Pure HTML5, Vanilla JavaScript, Modern CSS3
- **Veri Saklama:** Yerel JSON tabanlı şifrelenmiş dosya sistemi
- **Otomasyon:** Arkaplanda otomatik güncelleme desteği

## 🚀 Kurulum ve Çalıştırma

1. Repo'yu klonlayın:
   ```bash
   git clone https://github.com/musabhc/balance-track.git
   ```
...
## 📜 Lisans
Bu proje **Kişisel Kullanım Lisansı** ile korunmaktadır. Bireysel kullanım ücretsizdir, ancak ticari kullanım için yazılı izin gereklidir. Detaylar için [LICENSE](LICENSE) dosyasına bakınız.

---
*Musa tarafından geliştirilmiştir.*
